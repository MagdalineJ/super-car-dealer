...
After clicking the button **buy** a smaller icon of the car and and brand name will pop up in the left edge of the site, alongwith the total cost update.
In order to purchase if the **Purchase** button is clicked , the confirmation will come as congratulations text.
Moreover, by anytime if someone feels that the sellection is incorrect he/she may click on the **Cancel** button; so that the page will refresh and new selection can be made again. 
